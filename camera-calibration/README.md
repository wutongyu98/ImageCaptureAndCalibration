...
./calibrate -w 28 -h 17 -n 50 -s 0.02 -d "../calib_imgs/1/" -i "left" -o "cam_left.yml" -e "jpg"  
...
./calibrate -w 28 -h 17 -n 50 -s 0.02 -d "../calib_imgs/1/" -i "right" -o "cam_right.yml" -e "jpg"  
