...
void TcamCamera::set_trigger(bool trigger_mode_enabled)
{
    GValue trigger_val = {};
    g_value_init(&trigger_val, G_TYPE_BOOLEAN);
    g_value_set_boolean(&trigger_val, trigger_mode_enabled);
...
void TcamCamera::set_low_latency_mode(bool enabled) {
  GValue set_imx_low_latency_mode = G_VALUE_INIT;
  g_value_init(&set_imx_low_latency_mode, G_TYPE_BOOLEAN);
  g_value_set_boolean(&set_imx_low_latency_mode, enabled);
  tcam_prop_set_tcam_property(TCAM_PROP(tcambin_), "IMX Low-Latency Mode", &set_imx_low_latency_mode);
}

void TcamCamera::set_trigger_polarity_pos(bool polarity_pos) {
  GValue set_trigger_polarity_pos = G_VALUE_INIT;
  g_value_init(&set_trigger_polarity_pos, G_TYPE_BOOLEAN);
  g_value_set_boolean(&set_trigger_polarity_pos, polarity_pos);
  tcam_prop_set_tcam_property(TCAM_PROP(tcambin_), "Trigger Polarity", &set_trigger_polarity_pos);
}

void TcamCamera::set_strobe_enable(bool strobe_enable){
  GValue set_strobe_enable = G_VALUE_INIT;
  g_value_init(&set_strobe_enable, G_TYPE_BOOLEAN);
  g_value_set_boolean(&set_strobe_enable, strobe_enable);
  tcam_prop_set_tcam_property(TCAM_PROP(tcambin_), "Strobe Enable", &set_strobe_enable);
}

void TcamCamera::set_strobe_polarity_pos(bool strobe_polarity_pos){
  GValue set_strobe_polarity_pos = G_VALUE_INIT;
  g_value_init(&set_strobe_polarity_pos, G_TYPE_BOOLEAN);
  g_value_set_boolean(&set_strobe_polarity_pos, strobe_polarity_pos);
  tcam_prop_set_tcam_property(TCAM_PROP(tcambin_), "Strobe Polarity", &set_strobe_polarity_pos);
}

void TcamCamera::set_strobe_length_is_exposure(bool strobe_length_is_exposure){
  GValue set_strobe_length_is_exposure = G_VALUE_INIT;
  g_value_init(&set_strobe_length_is_exposure, G_TYPE_BOOLEAN);
  g_value_set_boolean(&set_strobe_length_is_exposure, strobe_length_is_exposure);
  tcam_prop_set_tcam_property(TCAM_PROP(tcambin_), "Strobe Exposure", &set_strobe_length_is_exposure);
}

void TcamCamera::set_strobe_delay_us(int strobe_delay_us) {
  GValue set_strobe_delay_us = G_VALUE_INIT;
  g_value_init(&set_strobe_delay_us, G_TYPE_INT);
  g_value_set_int(&set_strobe_delay_us, strobe_delay_us);
  tcam_prop_set_tcam_property(TCAM_PROP(tcambin_), "Strobe Delay", &set_strobe_delay_us);
}
...
void TcamCamera::set_white_balance_auto(bool white_balance_auto) {
  GValue set_white_balance_auto = G_VALUE_INIT;
  g_value_init(&set_white_balance_auto, G_TYPE_BOOLEAN);
  g_value_set_boolean(&set_white_balance_auto, white_balance_auto);
  tcam_prop_set_tcam_property(TCAM_PROP(tcambin_), "Whitebalance Auto", &set_white_balance_auto);
}
