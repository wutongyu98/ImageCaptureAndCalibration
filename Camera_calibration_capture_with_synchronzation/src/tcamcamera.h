...
class TcamCamera
{
    public:
        ...
        */
        ...
        void set_trigger(bool trigger_mode_enabled);
        void set_low_latency_mode(bool enabled);
        void trigger();
        void set_trigger_polarity_pos(bool polarity_pos);
        void set_auto_exposure();
        void set_exposure_time(int exposure_time);
        void set_white_balance_auto(bool white_balance_auto);

        void set_strobe_enable(bool strobe_enable);
        void set_strobe_polarity_pos(bool strobe_polarity_pos);
        void set_strobe_length_is_exposure(bool strobe_length_is_exposure);
        void set_strobe_delay_us(int strobe_delay_us);
        /*
